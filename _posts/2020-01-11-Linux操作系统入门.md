...
layout:     post
title:      Linux操作系统入门
subtitle:   对于开发人员来说，Linux是非常重要的一门技术。
date:       2020-01-11
author:     guohang
header-img: img/post-bg-linux1.jpg
catalog: true
tags:
    - Linux
    - 操作系统
...
![Linux发行版](https://raw.githubusercontent.com/guohangbk/picBed/master/img/1578737899.png)
...
安装比较简单，步骤不一一赘述，这里有一个不错的教程，可以看看。
...
因为ip地址默认是动态的，有时候重启linux就可能更换ip地址，这样xshell中配置的ip链接就会失效，所以我们可以将ip设置为静态的。
...
![配置静态IP](https://raw.githubusercontent.com/guohangbk/picBed/master/img/1578740259.png)
...
![解决Xshell乱码](https://raw.githubusercontent.com/guohangbk/picBed/master/img/1578741127.png)
...
![Linux目录](https://raw.githubusercontent.com/guohangbk/picBed/master/img/1578741764.png)
...
1. ip addr：查询ip地址 
   ...
   ![查询ip](https://raw.githubusercontent.com/guohangbk/picBed/master/img/1578742020.png)
